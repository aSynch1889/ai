...
- (void)creatControl
{
    ...
    //选项栏
    UIView *tabBarView = [[UIView alloc] initWithFrame:CGRectMake(0, kSCREEN_HEIGHT - kTabbarHeight, kSCREEN_WIDTH, kTabbarHeight)];
    tabBarView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.8f];
    [self.view addSubview:tabBarView];
    
    //开启照明按钮
    UIButton *lightBtn = [[UIButton alloc] initWithFrame:CGRectMake(kSCREEN_WIDTH - 100, 0, 100, kTabbarHeight)];
