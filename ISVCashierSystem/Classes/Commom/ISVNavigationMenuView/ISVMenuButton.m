...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.arrow = [[UIImageView alloc] initWithImage:[ISVMenuConfiguration arrowImage]];
...
- (void)layoutSubviews
{
    ...
    self.arrow.center = CGPointMake(CGRectGetMaxX(self.title.frame) + [ISVMenuConfiguration arrowPadding], self.frame.size.height / 2);
