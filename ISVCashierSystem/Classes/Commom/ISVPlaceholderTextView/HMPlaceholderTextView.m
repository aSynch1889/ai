...
/**
 * #import "HMPlaceholderTextView.h"
 @interface HMHomeViewController () <UITextViewDelegate>
 // 文本输入控件 
@property (nonatomic, weak) HMPlaceholderTextView *textView;
@end
...
- (void)viewDidLoad {
    ...
    [self setUpNav];
    HMPlaceholderTextView *textView = [[HMPlaceholderTextView alloc] init];
