...
#import "HMItemSwitchBar.h"

#define btnWidth 64
#define margin 5

@interface HMItemSwitchBar ()
@property (nonatomic, weak) UIView *lineView;
@property (nonatomic, weak) UIButton *selectedBtn;
@end

@implementation HMItemSwitchBar

+ (instancetype)itemSwitchBarWithTitles:(NSArray *)titles
{
    HMItemSwitchBar *bar = [[self alloc] initWithFrame:CGRectMake(0, 0, btnWidth*2 +margin, 40)];
