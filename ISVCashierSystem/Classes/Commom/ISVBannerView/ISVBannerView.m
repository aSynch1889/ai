...
#import "ISVBannerView.h"
#import "ISVBannerViewCell.h"
#import "NSData+ISVDataCache.h"

NSString *const ID = @"ISVBannerViewCell";

@interface ISVBannerView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[ISVBannerViewCell class] forCellWithReuseIdentifier:ID];
...
{
    ISVBannerView *bannerView = [[self alloc] initWithFrame:frame];
...
{
    ISVBannerViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
