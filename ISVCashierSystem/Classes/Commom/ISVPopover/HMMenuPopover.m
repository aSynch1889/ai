...
#define CELL_IDENTIGIER         @"HMMenuPopoverCell"
...
@interface HMMenuPopover () <UITableViewDataSource, UITableViewDelegate>
...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems andIconItems:(NSArray*)iconItems
{
    ...
    if (self = [super initWithFrame:frame])
    {
        ...
        UIImage *pointerImg = [UIImage imageNamed:@"HMPopover_pointer"];
        ...
        _bgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"HMPopover_item_bg"]];
...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems
{
    if (self = [super initWithFrame:frame])
    {
        ...
        _menuPointerView.image = [UIImage imageNamed:@"HMPopover_pointer"];
        _menuPointerView.tag = MENU_POINTER_TAG;
        [self.containerButton addSubview:_menuPointerView];
...
- (void)addSeparatorImageToCell:(UITableViewCell *)cell
{
    ...
    [separatorImageView setImage:[UIImage imageNamed:@"HMPopover_Line"]];
