...
#import "HMTabBarForUpViewController.h"

@interface HMTabBarForUpViewController ()
...
@implementation HMTabBarForUpViewController
{
...
- (void)viewDidLoad
{
    ...
    // 选中按钮角标
    if (_showIndicator) {
        _indicatorImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"HMTabBarForUpIndicator"]];
...
//    UIImage *inactiveImage = [[UIImage imageNamed:@"HMTabBarForUpInactiveTab"] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
//    UIImage *activeImage = [[UIImage imageNamed:@"HMTabBarForUpActiveTab"] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
//    
...
{
    NSAssert([newViewControllers count] >= 2, @"HMTabBarForUpViewController requires at least two view controllers");
