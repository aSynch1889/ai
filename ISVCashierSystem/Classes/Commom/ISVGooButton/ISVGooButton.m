...
#import "ISVGooButton.h"

// 最大圆心距离
#define kMaxDistance 80

@interface ISVGooButton ()
{
    CGFloat _oriSmallRadius;
    CGPoint _oriSmallPoint;
}
...
- (void)layoutSubviews
{
    ...
    // 设置小圆位置
    self.smallCircleView.center = _oriSmallPoint;
}
    ...
    if (pan.state == UIGestureRecognizerStateEnded) {
        ...
        if (d > kMaxDistance) {
            ...
            for (int i = 1; i < 9; i++) {
                ...
                UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"gooButton_boo_%d.jpg",i]];
                if (image) {
