...
@interface ISVAssetsGroupController ()
...
@implementation ISVAssetsGroupController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ISVAssetsGroupCell *cell = [ISVAssetsGroupCell groupCell:tableView];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ISVAssetsItemController *collectionVC = [[ISVAssetsItemController alloc] init];
