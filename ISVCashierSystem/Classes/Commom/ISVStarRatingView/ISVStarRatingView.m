...
#import "ISVStarRatingView.h"

#define FOREGROUND_STAR_IMAGE_NAME @"evaluateOrder_icon_score_sel"
#define BACKGROUND_STAR_IMAGE_NAME @"evaluateOrder_icon_score_nor"
#define DEFALUT_STAR_NUMBER 5
#define ANIMATION_TIME_INTERVAL 0.2

@interface ISVStarRatingView()
...
@implementation ISVStarRatingView
...
- (void)layoutSubviews {
    ...
    __weak ISVStarRatingView *weakSelf = self;
