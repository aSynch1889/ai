...
@interface ISVInputBar () <JSQMessagesInputToolbarDelegate,
...
@implementation ISVInputBar

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ISVInputBar class])
                          bundle:[NSBundle bundleForClass:[ISVInputBar class]]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([ISVInputBar class])
                                          bundle:[NSBundle bundleForClass:[ISVInputBar class]]];
}
