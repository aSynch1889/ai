...
#import "HMFormField.h"

@interface HMFormField () <UITextFieldDelegate>

@end

@implementation HMFormField

+ (instancetype)indicatorFieldWithPoint:(CGPoint)point tapBlock:(void (^)())block
{
    HMFormField *field = [[self alloc] initWithFrame:CGRectMake(point.x, point.y, kSCREEN_WIDTH - point.x - 25, 30)];
