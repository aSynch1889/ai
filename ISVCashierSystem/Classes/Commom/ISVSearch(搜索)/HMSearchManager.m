...
#import "HMSearchManager.h"

@interface HMSearchManager ()<UISearchControllerDelegate, UISearchDisplayDelegate, UISearchResultsUpdating>
{
    HMSearchResultViewController *_searchResultViewController;
}
...
@implementation HMSearchManager
...
{
    HMSearchManager *manager = [[self alloc] init];
...
- (void)setResultOpreation:(void (^)(id<HMSearchPotocol>))resultOpreation
{
...
- (HMSearchResultViewController *)searchResultViewController
{
    if (_searchResultViewController == nil) {
        _searchResultViewController = [HMSearchResultViewController defaultViewController];
