...
- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    ...
    if (self) {
        ...
        NSLog(@"cropFrame:%f",cropFrame.size.height);
...
- (void)initView
{
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_WIDTH, kSCREEN_HEIGHT)];
    ...
    self.ratioView.layer.borderColor = [UIColor colorWithRed:0.201 green:0.641 blue:0.237 alpha:1.000].CGColor;
...
-(UIImage *)getSubImage
{
    ...
    NSLog(@"cropFrame:%f",squareFrame.size.height);
    ...
    NSLog(@"(%f %f)",smallImage.size.width,smallImage.size.height);
    return smallImage;
}
