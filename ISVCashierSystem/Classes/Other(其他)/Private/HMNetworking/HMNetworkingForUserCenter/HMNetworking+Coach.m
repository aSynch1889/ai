...
#import "HMNetworking+Coach.h"

@implementation HMNetworking (Coach)
...
/*
 ...
 {
 "HM_PT_Name":"杨小二",
 "HM_PT_IDCard":"430525188806236789",
 "HM_PT_Education":1,
 "HM_PT_Qualification":1,
 "HM_PT_Team":"中国武术队",
 "HM_PT_College":"中华武术学院",
 "HM_PT_CourseCost":2000.00,
 "HM_PT_ProfessionalProgram":1,
 "HM_PT_TeachingProgram":"八级拳",
 "HM_PT_Province":"广东",
 "HM_PT_City":"广州",
 "HM_PT_TeachingSite":"体育馆",
 "HM_PT_Introduction":"全国武术冠军",
 "HM_PT_InviteCode":"123456"
 }
 参数说明：
 参数	是否必须	描述
 key	是	用户登录后返回的token
 HM_PT_Name	是	姓名
 HM_PT_IDCard	是	身份证号
 HM_PT_Education	是	学历
 HM_PT_Qualification	是	资质证明
 HM_PT_CourseCost	是	课程费用
 HM_PT_ProfessionalProgram	是	专业项目
 HM_PT_TeachingProgram	是	可授课项目
 HM_PT_Province	是	省份
 HM_PT_City	是	城市
 HM_PT_TeachingSite	是	教学场地
 HM_PT_Introduction	是	个人简介
 HM_PT_InviteCode	是	邀请码
 HM_PT_Team	否	专业队
 HM_PT_College	否	毕业学校
 ...
 */
#pragma - 私教注册
+ (void)coachApplyWithName:(NSString *)HM_PT_Name
                      card:(NSString *)HM_PT_IDCard
                 education:(NSString *)HM_PT_Education
             qualification:(NSString *)HM_PT_Qualification
                      team:(NSString *)HM_PT_Team
                   college:(NSString *)HM_PT_College
                courseCost:(NSString *)HM_PT_CourseCost
       professionalProgram:(NSString *)HM_PT_ProfessionalProgram
           teachingProgram:(NSString *)HM_PT_TeachingProgram
                  province:(NSString *)HM_PT_Province
                      city:(NSString *)HM_PT_City
              teachingSite:(NSArray *)HM_PT_TeachingSite
              introduction:(NSString *)HM_PT_Introduction
                inviteCode:(NSString *)HM_PT_InviteCode
        orderDuration_Base:(NSArray *)HM_PT_OrderDuration_Base
         certificateImages:(NSDictionary *)HM_PT_Certificateimgs
                   ...
                   failure:(ErrorBlock)failure
{
    ...
    NSNumber *HM_PT_IsHomeService = @(isHomeService);

    NSDictionary *model = NSDictionaryOfVariableBindings(HM_PT_Name,
                                                         HM_PT_IDCard,
                                                         HM_PT_Education,
                                                         HM_PT_Qualification,
                                                         HM_PT_Team,
                                                         HM_PT_College,
                                                         HM_PT_CourseCost,
                                                         HM_PT_ProfessionalProgram,
                                                         HM_PT_TeachingProgram,
                                                         HM_PT_Province,
                                                         HM_PT_City,
                                                         HM_PT_TeachingSite,
                                                         HM_PT_Introduction,
                                                         HM_PT_InviteCode,
                                                         HM_PT_OrderDuration_Base,
                                                         HM_PT_Certificateimgs,
                                                         HM_PT_IsHomeService
                                                         );
...
/*
 ...
 HM_PT_Team	否	专业队
 HM_PT_College	否	毕业学校
 HM_PT_TeachingProgram	否	私教授课项目
...
+ (void)coachModifyWithEducation:(NSUInteger)education
             ...
             professionalProgram:(NSUInteger)professionalProgram
                          IDCard:(NSString *)HM_PT_IDCard
                            name:(NSString *)HM_PT_Name
                   qualification:(NSUInteger)qualification
                 certificateimgs:(NSDictionary *)HM_PT_Certificateimgs
                   isHomeService:(BOOL)isHomeService
                         ...
                         failure:(ErrorBlock)failure
{
    ...
    NSNumber *HM_PT_IsHomeService = @(isHomeService);
    NSNumber *hm_pt_isorder = @(isOrder);
    NSNumber *HM_PT_CourseCost = @(courseCost);
    NSNumber *HM_PT_Education = @(education);
    NSNumber *HM_PT_ProfessionalProgram = @(professionalProgram);
    NSNumber *HM_PT_Qualification = @(qualification);
...
/*
 ...
 传入Json：
 {
 "HM_OSM_OrderDuration": "19:00-20:00,20:00-21:00",
 "HM_OSM_Longitude": 23.2,
 "HM_OSM_Latitude": 113.3
 }
 参数说明：
 参数	是否必须	描述
 key	是	用户登录后返回的token
 HM_OSM_OrderDuration	是	接单时段
 HM_OSM_Longitude	是	私教经度
 HM_OSM_Latitude	是	私教纬度
...
//+ (void)startOrderModeWithOrderDuration:(NSArray *)HM_OSM_OrderDuration success:(RespondBlock)success failure:(ErrorBlock)failure
//{
//#warning 需从定位模块获取
//    NSString *HM_OSM_Longitude = @"113.27";
//    NSString *HM_OSM_Latitude = @"23.13";
//    
//    NSString *url = [NSString stringWithFormat:@"%@/%@", START_ORDER_MODE, [HMNetworking token]];
//    NSDictionary *param = NSDictionaryOfVariableBindings(HM_OSM_OrderDuration, HM_OSM_Longitude, HM_OSM_Latitude);
//    
//    [self postWithURL:url params:param success:^(id respondData) {
//        success(respondData);
//    } failure:^(HMErrorModel *error) {
...
/*
 ...
 2.这四种条件下获取的商品包括淘宝商品和健康猫商品，它们分页显示，page为第几页，count为每页商品数量；
 3.
 ...
 "totalp_images": "[{\"id\":2307,\"hm_product_id\":\"5xfir23v\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/FvMoZ4fn93s5QJGJdMtWmxrQ0rpB?imageView2/2/w/480/q/95/@w/$w$@/@h/$h$@\",\"img\":\"qn|xaya|FvMoZ4fn93s5QJGJdMtWmxrQ0rpB\"},{\"id\":2308,\"hm_product_id\":\"5xfir23v\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/FrIL3iPOvh2QmEHn22q3sS5NPPjF?imageView2/2/w/480/q/95/@w/$w$@/@h/$h$@\",\"img\":\"qn|xaya|FrIL3iPOvh2QmEHn22q3sS5NPPjF\"},{\"id\":2309,\"hm_product_id\":\"5xfir23v\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/Fs_ZCWpU0A9en1FOJwkuKYU-9a5j?imageView2/2/w/480/q/95/@w/$w$@/@h/$h$@\",\"img\":\"qn|xaya|Fs_ZCWpU0A9en1FOJwkuKYU-9a5j\"},{\"id\":2310,\"hm_product_id\":\"5xfir23v\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/Fkuc_SIE-6mzaaC4WTSyc5OP3fhc?imageView2/2/w/480/q/95/@w/$w$@/@h/$h$@\",\"img\":\"qn|xaya|Fkuc_SIE-6mzaaC4WTSyc5OP3fhc\"}]",
 ...
 "totalp_istaobao": false,
 "totalp_iscrossborder": false,
 "totalp_images": "[{\"id\":1998,\"hm_product_id\":\"5xfjdj97\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/FpbVZtGcVlue2qgTi4ig4KOK3aRL?imageView2/2/w/480/q/95/@w/$w$@/@h/$h$@\",\"img\":\"qn|xaya|FpbVZtGcVlue2qgTi4ig4KOK3aRL\"},{\"id\":1997,\"hm_product_id\":\"5xfjdj97\",\"url\":\"http://7xl05m.com2.z0.glb.qiniucdn.com/FsN_yMU