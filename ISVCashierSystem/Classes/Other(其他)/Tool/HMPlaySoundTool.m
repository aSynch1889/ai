...
//  HealthMall
//
//  Created by qiuwei on 15/12/10.
//  Copyright © 2015年 HealthMall. All rights reserved.
//

#import "HMPlaySoundTool.h"

#define DISPOSE_INTERVAL 3

@implementation HMPlaySoundTool

static HMPlaySoundTool *instance = nil;

+ (HMPlaySoundTool *)sharePlaySoundTool{
    
    //同步防止多线程访问,这里本来想用instance来作为锁对象的，但是当instance为nil的时候不能作为锁对象
    @synchronized(self){
        if (!instance) {
            instance= [[HMPlaySoundTool alloc]init];
        }
    }
    return instance;
}
